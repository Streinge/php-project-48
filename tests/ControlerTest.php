...
class ControlerTest extends TestCase
{
    public function testControler(): void
    {
        ...
        $this->assertEquals(stringify($exeptedArray1), controler("{$pathFix}file1.json", "{$pathFix}file2.json"));
        $this->assertEquals(stringify($exeptedArray1), controler("{$pathFix}file1.yml", "{$pathFix}file2.yml"));
